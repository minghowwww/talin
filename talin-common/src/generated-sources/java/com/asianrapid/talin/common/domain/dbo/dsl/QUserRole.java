...
public class QUserRole extends EntityPathBase<UserRole> {
    ...
    public final com.asianrapid.talin.common.domain.dbo.primaryKey.dsl.QUserRolePK id;
    ...
    public QUserRole(Class<? extends UserRole> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.asianrapid.talin.common.domain.dbo.primaryKey.dsl.QUserRolePK(forProperty("id")) : null;
